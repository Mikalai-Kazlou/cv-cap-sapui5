sap.ui.define(function () {
  ...
  return {
    ...
    summary:
      ...
      '<p style="margin: .25rem 0rem">' +
      "Fully proficient in both backend and frontend SAP development along with knowledge of the methodology. Implementing an analytical and disciplined approach to development projects, coupled with the ability to work independently without supervision.</p>" +
      '<p style="margin: .25rem 0rem">' +
